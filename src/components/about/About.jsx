            ...
            >
                ...
                <div className="grid max-w-screen-xl grid-cols-1 gap-10 mt-8 mx-auto lg:py-8 lg:grid-cols-2">
                    ...
                    <div className="flex flex-col items-center w-full lg:items-start justify-between gap-">
                        <h1 className="text-2xl text-center text-black font-bakbak-one lg:text-3xl dark:text-white lg:text-right mt-4 lg:mt-0">
						¿Quienes Somos?
                        </h1>
                        <p className="lg:leading-loose mt-8 text-lg font-normal text-justify text-black lg:text-justify lg:text-2xl sm:px-16 lg:px-0 dark:text-white font-montserrat lg:mt-0">
                        ...
                        <p className="mt-8 text-lg font-normal text-justify text-black lg:text-justify dark:text-white lg:text-2xl sm:px-16 lg:px-0 font-montserrat lg:mt-0 lg:leading-loose">
